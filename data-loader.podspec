#
#  Be sure to run `pod spec lint ts_http.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/pedja1/data-loader-ios"
  ...
  s.source_files  = "data-loader", "data-loader/**/*.{h,m}"
